...
init( modVersion )
{
	braxi\_dvar::addDvar( "welcome_message1", "welcome_message1", "Welcome to ^17th sense runners ^7Death Run server!", "", "", "string" );
	braxi\_dvar::addDvar( "welcome_message2", "welcome_message2", "^3Visit www.7sense-runners.com", "", "", "string" );
